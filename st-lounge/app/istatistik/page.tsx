...
export default async function IstatistikPage() {
  ...
  const isAuthenticated =
    verifyAdminSessionToken(adminSession);
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Sayaç sıfırlandığında yeni
            bir istatistik dönemi
            başlatılır. Eski kayıtlar
            silinmez.
          </p>
